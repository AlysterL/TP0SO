...
int main(void)
{
	...
	log_info(logger,"Lei el valor de la CLAVE %s, el PUERTO %s y el IP %s\n",valor, puerto, ip) ;
...
t_log* iniciar_logger(void)
{
	...
	nuevo_logger = log_create("tp0.log","unLog", true ,LOG_LEVEL_INFO);
...
void leer_consola(t_log* logger)
{
	...
	while(strcmp(leido,"\0") != 0) {
		leido = readline("");
		log_info(logger,"Lei las lineas %s\n", leido);
	}
